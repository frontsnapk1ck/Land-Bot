...
public class BuildingCommands extends PlayerCommand {
    ...
    public static final String IMAGE_ADDRESS = "https://i.imgur.com/5YhU4SF.png";
    ...
    {
        String out = "";
        String[] message = FileReader.read(AlloyUtil.ALLOY_PATH + "res\\globals\\help\\buildingHelp.msg");
