...
public class RankCommands extends PlayerCommand {
    ...
    private String getLBRank(Player player) 
    {
        ...
        List<Rank> stock = rlt.loadALl(AlloyUtil.ALLOY_PATH + "res\\globals\\defualt\\rank.txt");
    ...
    {
        String out = "";
        String[] message = FileReader.read(AlloyUtil.ALLOY_PATH + "res\\globals\\help\\rankHelp.msg");
