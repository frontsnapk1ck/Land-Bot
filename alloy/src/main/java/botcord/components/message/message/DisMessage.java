...
import botcord.components.message.message.attachment.AbstractMessageAttachment;
import botcord.components.message.message.attachment.DisMessageAttachment;
