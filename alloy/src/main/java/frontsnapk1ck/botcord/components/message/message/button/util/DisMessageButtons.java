...
import frontsnapk1ck.botcord.components.message.message.button.MessageDeleteButton;
import frontsnapk1ck.botcord.components.message.message.button.MessageEditButton;
import frontsnapk1ck.botcord.components.message.message.button.MessageGetLinkButton;
import frontsnapk1ck.botcord.components.message.message.button.MessagePinButton;
import frontsnapk1ck.botcord.components.message.message.button.MessageReplyButton;
...
public class DisMessageButtons extends BCPanel {
    ...
    public void init() 
    {
        this.buttons = new ArrayList<AbstractMessageButtons>();
        perms = getPerms();
    }
