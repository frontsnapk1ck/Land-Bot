...
public class UpdateManager extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        this.checkFileSystem(e.getGuild().getName());
    }

    private void checkFileSystem(String name) {
        ...
        if (!dir.exists()) 
        {
            ...
            try {
                ...
                String[] boSS = { "prefix:!" , 
                                ...
                                "cooldown:10" , 
                                "role assign on buy:false"};
                
                Saver.saveOverwite(boS.getPath(), boSS );

                String[] buSS = {   "shack:2500:15" ,
                                    "apartment:7500:50" ,
                                    "townhome:14500:110" ,
                                    "bungalow:18000:175" ,
    ...
    {
        this.checkFileSystem(e.getNewName());
